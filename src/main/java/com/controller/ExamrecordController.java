    ...
    */
    ...
    public R save(@RequestBody ExamrecordEntity examrecord, HttpServletRequest request){
        ...
        if(examrecordEntity==null){
            ...
            caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"新增",examrecord.toString());
            return R.ok();
        }else {
...
//            examrecord.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
            ...
            List<String> strings = caozuorizhiService.clazzDiff(examrecord, oldExamrecordEntity, request,new String[]{"updateTime"});
    ...
    */
    ...
    public R delete(@RequestBody Integer[] ids, HttpServletRequest request){
        ...
        caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"删除",oldExamrecordList.toString());
        return R.ok();
    }
...
//                            examrecordEntity.setCreateTime(date);//时间
                        ...
                        caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"批量新增",examrecordList.toString());
                        return R.ok();
                    }
                }
            }
...
//            .notIn("examrecord_types", new Integer[]{102})
        ...
        examrecordService.insert(examrecord);
            ...
            caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"前台新增",examrecord.toString());
            return R.ok();
        }else {
            return R.error(511,"表中有相同数据");
        }
