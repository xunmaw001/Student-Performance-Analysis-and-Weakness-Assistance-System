    ...
    */
    ...
    public R save(@RequestBody ExamquestionEntity examquestion, HttpServletRequest request){
        ...
        if(examquestionEntity==null){
            ...
            caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"新增",examquestion.toString());
            return R.ok();
        }else {
...
//            return R.error(511,"永远不会进入");
            ...
            List<String> strings = caozuorizhiService.clazzDiff(examquestion, oldExamquestionEntity, request,new String[]{"updateTime"});
    ...
    */
    ...
    public R delete(@RequestBody Integer[] ids, HttpServletRequest request){
        ...
        caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"删除",oldExamquestionList.toString());
        return R.ok();
    }
...
//                            examquestionEntity.setCreateTime(date);//时间
                        ...
                        caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"批量新增",examquestionList.toString());
                        return R.ok();
                    }
                }
            }
...
//            .notIn("examquestion_types", new Integer[]{102})
        ...
        examquestionService.insert(examquestion);
            ...
            caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"前台新增",examquestion.toString());
            return R.ok();
        }else {
            return R.error(511,"表中有相同数据");
        }
