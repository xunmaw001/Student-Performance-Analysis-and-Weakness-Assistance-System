    ...
    */
    ...
    public R save(@RequestBody ExamrewrongquestionEntity examrewrongquestion, HttpServletRequest request){
        ...
        if(examrewrongquestionEntity==null){
            ...
            caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"新增",examrewrongquestion.toString());
            return R.ok();
        }else {
...
//            examrewrongquestion.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
            ...
            List<String> strings = caozuorizhiService.clazzDiff(examrewrongquestion, oldExamrewrongquestionEntity, request,new String[]{"updateTime"});
    ...
    */
    ...
    public R delete(@RequestBody Integer[] ids, HttpServletRequest request){
        ...
        caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"删除",oldExamrewrongquestionList.toString());
        return R.ok();
    }
...
//                            examrewrongquestionEntity.setCreateTime(date);//时间
                        ...
                        caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"批量新增",examrewrongquestionList.toString());
                        return R.ok();
                    }
                }
            }
...
//            .notIn("examrewrongquestion_types", new Integer[]{102})
        ...
        examrewrongquestionService.insert(examrewrongquestion);
            ...
            caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"前台新增",examrewrongquestion.toString());
            return R.ok();
        }else {
            return R.error(511,"表中有相同数据");
        }
