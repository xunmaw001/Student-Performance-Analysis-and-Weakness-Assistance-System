    ...
    */
    ...
    public R save(@RequestBody ExampapertopicEntity exampapertopic, HttpServletRequest request){
        ...
        if(exampapertopicEntity==null){
            ...
            caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"新增",exampapertopic.toString());
            return R.ok();
        }else {
...
//            return R.error(511,"永远不会进入");
            ...
            List<String> strings = caozuorizhiService.clazzDiff(exampapertopic, oldExampapertopicEntity, request,new String[]{"updateTime"});
    ...
    */
    ...
    public R delete(@RequestBody Integer[] ids, HttpServletRequest request){
        ...
        caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"删除",oldExampapertopicList.toString());
        return R.ok();
    }
...
//                            exampapertopicEntity.setCreateTime(date);//时间
                        ...
                        caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"批量新增",exampapertopicList.toString());
                        return R.ok();
                    }
                }
            }
...
//            .notIn("exampapertopic_types", new Integer[]{102})
        ...
        exampapertopicService.insert(exampapertopic);
            ...
            caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"前台新增",exampapertopic.toString());
            return R.ok();
        }else {
            return R.error(511,"表中有相同数据");
        }
