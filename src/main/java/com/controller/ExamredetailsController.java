    ...
    */
    ...
    public R save(@RequestBody ExamredetailsEntity examredetails, HttpServletRequest request){
        ...
        if(examredetailsEntity==null){
            ...
            caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"新增",examredetails.toString());
            return R.ok();
        }else {
...
//            examredetails.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
            ...
            List<String> strings = caozuorizhiService.clazzDiff(examredetails, oldExamredetailsEntity, request,new String[]{"updateTime"});
    ...
    */
    ...
    public R delete(@RequestBody Integer[] ids, HttpServletRequest request){
        ...
        caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"删除",oldExamredetailsList.toString());
        return R.ok();
    }
...
//                            examredetailsEntity.setCreateTime(date);//时间
                        ...
                        caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"批量新增",examredetailsList.toString());
                        return R.ok();
                    }
                }
            }
...
//            .notIn("examredetails_types", new Integer[]{102})
        ...
        examredetailsService.insert(examredetails);
            ...
            caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"前台新增",examredetails.toString());
            return R.ok();
        }else {
            return R.error(511,"表中有相同数据");
        }
